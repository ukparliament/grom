...
RSpec.configure do |config|
  ...
  config.before(:each) do
    stub_request(:get, "#{API_ENDPOINT}/dummy_people/1/dummy_parties.ttl").
        with(:headers => {'Accept'=>'application/n-triples, text/plain;q=0.5, application/n-quads, text/x-nquads, */*;q=0.1', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'User-Agent'=>'Ruby'}).
    ...
    stub_request(:get, "http://example.com/dummy_people/1.ttl").
        with(:headers => {'Accept'=>'application/n-triples, text/plain;q=0.5, */*;q=0.1', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'User-Agent'=>'Ruby'}).
        to_return(:status => 200, :body => PERSON_ONE_TTL, :headers => {})
